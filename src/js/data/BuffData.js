...
export const BUFF_TYPES = [
    ...
    },
    {
        ...
        icon: '⚡',
        color: '#ffab40',
        description: '공격속도 +0.02',
        apply(player) {
            player.attackSpeedMultiplier += 0.02;
            player.buffStacks.attackSpeed = (player.buffStacks.attackSpeed || 0) + 1;
        },
        getDisplay(stacks) { return `+${(stacks * 0.02).toFixed(2)}`; },
    },
    {
        type: 'speed',
        name: '이동속도 강화',
    ...
    },
    {
        ...
        icon: '🔮',
        color: '#7c4dff',
        description: '투사체 크기 +0.03',
        apply(player) {
            player.projectileSizeMultiplier += 0.03;
            player.buffStacks.projSize = (player.buffStacks.projSize || 0) + 1;
        },
        getDisplay(stacks) { return `+${(stacks * 0.03).toFixed(2)}`; },
    },
    {
        type: 'projCount',
        name: '투사체 추가',
    ...
    },
    {
        ...
        apply(player) {
            ...
            player.stageStats.defense = (player.stageStats.defense || 0) + 1;
